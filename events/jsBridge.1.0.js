(function () {
    ...
    var isApp = getParam('isapp'),
        loginToken=getParam('loginToken');
    if(isApp){
        localStorage.setItem('yw_user_loginToken',loginToken);
    }
    ...
    var JSBridge = function () {
        ...
        this.share = function () {
            ...
            if (isApp) {
                ...
                if (shareMask.length) {
                    shareMask.show().on('click.share_mask', function () {
                        shareMask.hide().off('click.share_mask');
                    });
                } else {
        ...
        this.transferList=function () {
            if(isApp){
                window.location = "active/transfer";
            }else{
