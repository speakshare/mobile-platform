var webpack = require("webpack"),
    ...
    _config = {
        ...
        output: {
            ...
            path: __dirname + "/dist/",
            filename: "bundle_" + pkg.version + (!debug ? ".min.js" : ".js"),
...
if(debug){
    ...
    _config.output.publicPath='https://filetest.91yaowang.com/yaowang/events/baiNaFinacing/dist/';
    _config.plugins.push(new webpack.optimize.UglifyJsPlugin());
}else if(build_realse) {
    _config.output.publicPath='https://file.91yaowang.com/yaowang/events/baiNaFinacing/dist/';
    _config.plugins.push(new webpack.optimize.UglifyJsPlugin());
